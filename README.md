...
- Main Table S1: Full list of 268 included studies with extracted metadata and risk-of-bias assessments. https://nortop.github.io/slr-graph-leak/slr_phase5_6.html
- Table S2: Complete data extraction matrix (Phase 5) and
quantitative coding (Phase 6) for all studies; working sheets : SLR_Phase5_8_Extraction_Workbook.xlsx
- PRISMA 2020 checklist:
- Export of Scopus search result : scopus_export_Feb 25-2026_6611d842-83e3-41df-8a71-9f6b1969c016.csv
  Keyword-based screening protocol documentation working sheets: Layer3_PRISMA_Phase2_5_SUM.xlsx
- Checklist of full-text access : retrieval_report_v2_with_manual_columns.xlsx 
